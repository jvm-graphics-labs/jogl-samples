...
public class Gl_320_fbo_layered extends Test {
    ...
    private IntBuffer framebufferName = GLBuffers.newDirectIntBuffer(1),
            ...
            textureColorbufferName = GLBuffers.newDirectIntBuffer(1);
    ...
    private boolean initProgram(GL3 gl3) {
        ...
        if (validated) {
            ...
            shaderCodes[Shader.VERT1] = ShaderCode.create(gl3, GL_VERTEX_SHADER, this.getClass(), SHADERS_ROOT, null,
                    SHADERS_SOURCE1, "vert", null, true);
            shaderCodes[Shader.GEOM1] = ShaderCode.create(gl3, GL_GEOMETRY_SHADER, this.getClass(), SHADERS_ROOT, null,
                    SHADERS_SOURCE1, "geom", null, true);
            shaderCodes[Shader.FRAG1] = ShaderCode.create(gl3, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT, null,
        ...
        if (validated) {
            ...
            shaderCodes[Shader.VERT2] = ShaderCode.create(gl3, GL_VERTEX_SHADER, this.getClass(), SHADERS_ROOT, null,
                    SHADERS_SOURCE2, "vert", null, true);
            shaderCodes[Shader.FRAG2] = ShaderCode.create(gl3, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT, null,
    ...
    private boolean initTexture(GL3 gl3) {
        ...
        gl3.glGenTextures(1, textureColorbufferName);

        gl3.glActiveTexture(GL_TEXTURE0);
        gl3.glBindTexture(GL_TEXTURE_2D_ARRAY, textureColorbufferName.get(0));
    ...
    protected boolean end(GL gl) {
        ...
        gl3.glDeleteTextures(1, textureColorbufferName);
