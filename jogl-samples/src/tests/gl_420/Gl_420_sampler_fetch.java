    ...
    private boolean initProgram(GL4 gl4) {
        ...
        if (validated) {
            ...
            ShaderCode vertShaderCode = ShaderCode.create(gl4, GL_VERTEX_SHADER, this.getClass(), SHADERS_ROOT,
                    null, SHADER_SOURCE, "vert", null, true);
            ShaderCode fragShaderCodeFunc = ShaderCode.create(gl4, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT,
                    null, SHADER_SOURCE_FUNC, "frag", null, true);
            ShaderCode fragShaderCodeProg = ShaderCode.create(gl4, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT,
                    null, SHADER_SOURCE_PROG, "frag", null, true);
            ShaderCode libShaderCode = ShaderCode.create(gl4, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT,
                    null, SHADER_LIBRARY, "frag", null, true);
        ...
        if (validated) {
            ...
            gl4.glUseProgramStages(pipelineName.get(Program.PROG), GL_VERTEX_SHADER_BIT | GL_FRAGMENT_SHADER_BIT,
                    programName[Program.PROG]);
            gl4.glUseProgramStages(pipelineName.get(Program.FUNC), GL_VERTEX_SHADER_BIT | GL_FRAGMENT_SHADER_BIT,
                    programName[Program.FUNC]);
        }
