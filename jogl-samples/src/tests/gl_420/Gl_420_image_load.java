...
import jglm.Vec2;
import tests.gl_410.Gl_410_program_64;

/**
 *
 * @author GBarbieri
 */
public class Gl_420_image_load extends Test {

    public static void main(String[] args) {
        Gl_420_image_load gl_420_image_load = new Gl_420_image_load();
    }

    public Gl_420_image_load() {
        super("gl-420-image-load", Profile.CORE, 4, 2);
    }

    private final String SHADERS_SOURCE = "image-load";
    private final String SHADERS_ROOT = "src/data/gl_420";
    private final String TEXTURE_DIFFUSE = "kueken7_rgba16_sfloat.dds";
