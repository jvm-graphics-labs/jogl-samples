...
public class Gl_420_memory_barrier extends Test {
    ...
    private boolean initProgram(GL4 gl4) {
        ...
        if (validated) {
            ...
            ShaderCode vertShaderCode = ShaderCode.create(gl4, GL_VERTEX_SHADER, this.getClass(), SHADERS_ROOT, null,
                    SHADERS_SOURCE_BLIT, "vert", null, true);
            ShaderCode fragShaderCode = ShaderCode.create(gl4, GL_FRAGMENT_SHADER, this.getClass(), SHADERS_ROOT, null,
                    SHADERS_SOURCE_BLIT, "frag", null, true);
        ...
        if (validated) {
            ...
            gl4.glUseProgramStages(pipelineName.get(Pipeline.UPDATE), GL_VERTEX_SHADER_BIT | GL_FRAGMENT_SHADER_BIT,
                    programName[Program.UPDATE]);
            gl4.glUseProgramStages(pipelineName.get(Pipeline.BLIT), GL_VERTEX_SHADER_BIT | GL_FRAGMENT_SHADER_BIT,
    ...
    private boolean initFramebuffer(GL4 gl4) {
        ...
        validated = validated && (isFramebufferComplete(gl4, framebufferName.get(0)));
