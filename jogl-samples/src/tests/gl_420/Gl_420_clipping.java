 ...
 * @author GBarbieri
 */
public class Gl_420_clipping extends Test {

    public static void main(String[] args) {
        Gl_420_clipping gl_420_clipping = new Gl_420_clipping();
    }

    public Gl_420_clipping() {
        super("gl-420-clipping", Profile.CORE, 4, 2);
    }

    private final String SHADERS_SOURCE = "clipping";
    ...
    private int[] pipelineName = {0}, vertexArrayName = {0}, bufferName = new int[Buffer.MAX.ordinal()], textureName = {0};
