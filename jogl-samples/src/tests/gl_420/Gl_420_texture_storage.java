 ...
 * @author GBarbieri
 */
public class Gl_420_texture_storage extends Test {

    public static void main(String[] args) {
        Gl_420_texture_storage gl_420_texture_storage = new Gl_420_texture_storage();
    }

    public Gl_420_texture_storage() {
        super("gl-420-texture-storage", Profile.CORE, 4, 2);
    }
    ...
    private boolean initProgram(GL4 gl4) {
        ...
        if (validated) {
            ...
            ShaderProgram[] shaderPrograms = {new ShaderProgram(), new ShaderProgram()};
            ...
            shaderPrograms[Program.VERTEX.ordinal()].init(gl4);
            programName[Program.VERTEX.ordinal()] = shaderPrograms[Program.VERTEX.ordinal()].program();
            gl4.glProgramParameteri(programName[Program.VERTEX.ordinal()], GL_PROGRAM_SEPARABLE, GL_TRUE);
            shaderPrograms[Program.VERTEX.ordinal()].add(vertShaderCode);
            shaderPrograms[Program.VERTEX.ordinal()].link(gl4, System.out);

            shaderPrograms[Program.FRAGMENT.ordinal()].init(gl4);
            programName[Program.FRAGMENT.ordinal()] = shaderPrograms[Program.FRAGMENT.ordinal()].program();
            gl4.glProgramParameteri(programName[Program.FRAGMENT.ordinal()], GL_PROGRAM_SEPARABLE, GL_TRUE);
            shaderPrograms[Program.FRAGMENT.ordinal()].add(fragShaderCode);
            shaderPrograms[Program.FRAGMENT.ordinal()].link(gl4, System.out);
        }
