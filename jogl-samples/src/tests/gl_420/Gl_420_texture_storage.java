...
public class Gl_420_texture_storage extends Test {
    ...
    private boolean initProgram(GL4 gl4) {
        ...
        if (validated) {
            ...
            shaderPrograms[Program.VERTEX].init(gl4);
            programName[Program.VERTEX] = shaderPrograms[Program.VERTEX].program();
            gl4.glProgramParameteri(programName[Program.VERTEX], GL_PROGRAM_SEPARABLE, GL_TRUE);
            shaderPrograms[Program.VERTEX].add(vertShaderCode);
            shaderPrograms[Program.VERTEX].link(gl4, System.out);

            shaderPrograms[Program.FRAGMENT].init(gl4);
            programName[Program.FRAGMENT] = shaderPrograms[Program.FRAGMENT].program();
            gl4.glProgramParameteri(programName[Program.FRAGMENT], GL_PROGRAM_SEPARABLE, GL_TRUE);
            shaderPrograms[Program.FRAGMENT].add(fragShaderCode);
            shaderPrograms[Program.FRAGMENT].link(gl4, System.out);
        }
