...
public class Gl_440_fbo_depth_stencil extends Test {
    ...
    private boolean initTexture(GL4 gl4) {
        ...
        try {
            ...
            gl4.glActiveTexture(GL_TEXTURE0);
            gl4.glBindTexture(GL_TEXTURE_2D, textureName[Texture.DEPTHBUFFER]);
            gl4.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_BASE_LEVEL, 0);
            gl4.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAX_LEVEL, 0);
            ...
            gl4.glActiveTexture(GL_TEXTURE0);
            gl4.glBindTexture(GL_TEXTURE_2D, textureName[Texture.STENCILBUFFER]);
            gl4.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_BASE_LEVEL, 0);
            gl4.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAX_LEVEL, 0);
    ...
    private boolean initFramebuffer(GL4 gl4) {
        ...
        gl4.glFramebufferTexture(GL_FRAMEBUFFER, GL_STENCIL_ATTACHMENT, textureName[Texture.STENCILBUFFER], 0);
