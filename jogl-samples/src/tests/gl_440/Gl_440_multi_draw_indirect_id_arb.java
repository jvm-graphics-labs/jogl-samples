...
//    private final String TEXTURE_DIFFUSE = "kueken1-bgr8.dds";
    ...
    private IntBuffer bufferName = GLBuffers.newDirectIntBuffer(Buffer.MAX),
            ...
            pipelineName = GLBuffers.newDirectIntBuffer(1), uniformArrayStride = GLBuffers.newDirectIntBuffer(1);
    ...
    private boolean initProgram(GL4 gl4) {
        ...
        for (int i = 0; i < activeUniform[0]; ++i) {
            ...
            if (stringName.equals("transform.MVP[0]")) {
                ...
                IntBuffer indicesBuffer=GLBuffers.newDirectIntBuffer(new int[]{i});
                gl4.glGetActiveUniformsiv(programName, 1, indicesBuffer, GL_UNIFORM_ARRAY_STRIDE, uniformArrayStride);
                BufferUtils.destroyDirectBuffer(indicesBuffer);
            }
        }
