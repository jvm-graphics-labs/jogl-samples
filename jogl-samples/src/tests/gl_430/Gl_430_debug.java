...
import static com.jogamp.opengl.GL2ES2.GL_BUFFER;
...
import static com.jogamp.opengl.GL2ES2.GL_DEBUG_TYPE_MARKER;
...
import static com.jogamp.opengl.GL2ES2.GL_PROGRAM;
import static com.jogamp.opengl.GL2ES2.GL_PROGRAM_PIPELINE;
...
public class Gl_430_debug extends Test {
    ...
    private boolean initProgram(GL4 gl4) {
        ...
        if (validated) {
            ...
            gl4.glObjectLabel(GL_PROGRAM, programName[Program.VERTEX.ordinal()], -1,
            ...
            gl4.glObjectLabel(GL_PROGRAM, programName[Program.FRAGMENT.ordinal()], -1,
    ...
    private boolean initBuffer(GL4 gl4) {
        ...
        gl4.glObjectLabel(GL_BUFFER, bufferName[Buffer.ELEMENT.ordinal()], -1,
        ...
        gl4.glObjectLabel(GL_BUFFER, bufferName[Buffer.VERTEX.ordinal()], -1,
        ...
        gl4.glObjectLabel(GL_BUFFER, bufferName[Buffer.TRANSFORM.ordinal()], -1,
