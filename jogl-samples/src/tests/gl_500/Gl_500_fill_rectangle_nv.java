 ...
 * @author GBarbieri
 */
public class Gl_500_fill_rectangle_nv extends Test{
    
    public static void main(String[] args) {
        Gl_500_fill_rectangle_nv gl_500_fill_rectangle_nv = new Gl_500_fill_rectangle_nv();
    }

    public Gl_500_fill_rectangle_nv() {
        super("gl-500-fill-rectangle-nv", Profile.CORE, 4, 5);
    }
