 ...
 * @author GBarbieri
 */
public class Gl_500_shader_blend_nv extends Test{
    
    public static void main(String[] args) {
        Gl_500_shader_blend_nv gl_500_shader_blend_nv = new Gl_500_shader_blend_nv();
    }

    public Gl_500_shader_blend_nv() {
        super("gl-500-shader-blend-nv", Profile.CORE, 4, 5);
    }
