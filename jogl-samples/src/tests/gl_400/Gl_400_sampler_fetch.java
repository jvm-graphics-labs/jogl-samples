 ...
 * @author GBarbieri
 */
public class Gl_400_sampler_fetch extends Test {

    public static void main(String[] args) {
        Gl_400_sampler_fetch gl_400_sampler_fetch = new Gl_400_sampler_fetch();
    }

    public Gl_400_sampler_fetch() {
        super("gl-400-sampler-fetch", Profile.CORE, 4, 0);
    }

    private final String SHADERS_SOURCE = "fetch";
    ...
    private int[] bufferName = new int[Buffer.MAX.ordinal()], vertexArrayName = {0}, textureName = {0};
