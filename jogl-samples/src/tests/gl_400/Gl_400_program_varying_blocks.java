 ...
 * @author GBarbieri
 */
public class Gl_400_program_varying_blocks extends Test {

    public static void main(String[] args) {
        Gl_400_program_varying_blocks gl_400_program_varying_blocks = new Gl_400_program_varying_blocks();
    }

    public Gl_400_program_varying_blocks() {
        super("gl-400-program-varying-blocks", Profile.CORE, 4, 0);
    }

    private final String SHADERS_SOURCE = "tess-block";
