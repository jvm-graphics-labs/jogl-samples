 ...
 * @author GBarbieri
 */
public class Gl_320_scissor_test extends Test {

    public static void main(String[] args) {
        Gl_320_scissor_test gl_320_scissor_test = new Gl_320_scissor_test();
    }

    public Gl_320_scissor_test() {
        super("gl-320-scissor-test", 3, 2, new Vec2((float) Math.PI * 0.2f, (float) Math.PI * 0.2f));
    }

    private final String SHADERS_SOURCE = "scissor-test";
    ...
    private boolean initTexture(GL3 gl3) {
        ...
        try {
            ...
            Logger.getLogger(Gl_320_scissor_test.class.getName()).log(Level.SEVERE, null, ex);
        }
        return true;
    }
