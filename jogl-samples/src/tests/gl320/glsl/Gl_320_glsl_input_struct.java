 ...
 * @author GBarbieri
 */
public class Gl_320_glsl_input_struct extends Test {

    public static void main(String[] args) {
        Gl_320_glsl_input_struct gl_320_glsl_input_struct = new Gl_320_glsl_input_struct();
    }
