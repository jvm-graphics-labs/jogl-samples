...
import static com.jogamp.opengl.GL2ES2.GL_MAX_COLOR_TEXTURE_SAMPLES;
import static com.jogamp.opengl.GL2ES2.GL_MAX_DEPTH_TEXTURE_SAMPLES;
import static com.jogamp.opengl.GL2ES2.GL_MAX_INTEGER_SAMPLES;
import static com.jogamp.opengl.GL2ES2.GL_MAX_SAMPLE_MASK_WORDS;
...
public class Gl_320_fbo_multisample_integer extends Test {
    ...
    public Gl_320_fbo_multisample_integer() {
        super("Gl-320-fbo-multisample-integer", 3, 2);
    }
    ...
    private int[] vertexArrayName = new int[1], bufferName = new int[1], shaderName = new int[Shader.MAX.ordinal()],
