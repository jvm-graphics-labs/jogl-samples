...
import static com.jogamp.opengl.GL4.GL_QUERY_WAIT_INVERTED;
...
public class Gl_450_query_conditional extends Test {
    ...
    private int[] bufferName = new int[Buffer.MAX], vertexArrayName = {0}, pipelineName = {0}, queryName = {0};
    ...
    protected boolean render(GL gl) {
...

        {
            ...
            Mat4 model0 = new Mat4(1.0f).translate(new Vec3(0.0f, 0.0f, 8.0f));
        ...
        gl4.glBeginConditionalRender(queryName[0], GL_QUERY_WAIT_INVERTED);
        {	// Clear color buffer with black
