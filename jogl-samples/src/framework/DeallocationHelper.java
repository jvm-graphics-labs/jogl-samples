...
public class DeallocationHelper {
    ...
    public DeallocationHelper(final boolean ignoreClassesAndFieldsHints) {
                ...
                if (javaVendor.equals("The Android Project")) {
                    ...
                    if (/* javaVendor.equals("Apple Inc.")|| */javaVendor.equals("Free Software Foundation, Inc.")) {
                        ...
                        if (javaVendor.contains("Apache")) {
                            ...
                            if (javaVendor.equals("Jeroen Frijters")) {// TODO IKVM
                            } else {
                                if (javaVendor.contains("IBM")) {// TODO J9
                                }
                            }
                        }
                    }
        ...
        if (!attachmentOrByteBufferFieldNameMap.isEmpty()) {
            for (final Entry<String, String> attachmentOrByteBufferFieldNameEntry : attachmentOrByteBufferFieldNameMap.entrySet()) {
                ...
                } catch (ClassNotFoundException cnfe) {// TODO The Java version isn't very useful under
        ...
        if (attachmentOrByteBufferFieldNameMap.isEmpty()) {// detects everything with the reflection API
    ...
    public ByteBuffer findDeallocatableBuffer(Buffer buffer) {
        ...
        if (buffer != null && buffer.isDirect()) {// looks for any contained buffer in the passed buffer
            final Class<?> bufferClass = buffer.getClass();
            ...
            if (attachmentBufferOrByteBuffer == null) {// if it's a direct byte buffer and if it's an instance of
